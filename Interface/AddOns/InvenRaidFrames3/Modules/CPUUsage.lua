...
--	setBackColor(InvenRaidFrames3CPUUsage, 0)
	...
	InvenRaidFrames3CPUUsage:SetScript("OnUpdate", function(self, elapsed)
		...
		if updateTimer > updateFrequency then
			...
			SetItem("주문타이머", InvenRaidFrames3Member_NewUpdateSpellTimer)			
			SetItem("디버프", InvenRaidFrames3Member_NewUpdateDebuff)
			SetItem("공대버프", InvenRaidFrames3Member_NewUpdateBuffs)
			SetItem("생존기", InvenRaidFrames3Member_NewUpdateSurvivalSkill)
