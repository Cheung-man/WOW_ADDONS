...
local classList = { "WARRIOR", "PRIEST", "ROGUE", "MAGE", "WARLOCK", "HUNTER", "DRUID", "SHAMAN", "PALADIN", "DEATHKNIGHT", "MONK", "DEMONHUNTER", "EVOKER" }
local powerColor = { WARRIOR = "1", PRIEST = "05", ROGUE = "3", MAGE = "0", WARLOCK = "0", HUNTER = "2", DRUID = "013", SHAMAN = "09", PALADIN = "0", DEATHKNIGHT = "6", MONK ="03", DEMONHUNTER = "78", EVOKER = "10" }
local powerMatch = { ["0"] = "MANA", ["1"] = "RAGE", ["2"] = "FOCUS", ["3"] = "ENERGY", ["4"] = "LUNAR_POWER", ["5"] = "INSANITY", ["6"] = "RUNIC_POWER", ["7"] = "PAIN", ["8"] = "FURY", ["9"] = "MAELSTROM", ["10"] = "ESSENCE" }
